...
<#
.SYNOPSIS
    Deletes data that was generated by the PowerShell Compact-Archive Tool, but also uninstalls PSCAT from the system.

.DESCRIPTION
    This tool will provide a special instruction to the PowerShell Compact-Archive Tool to perform an uninstall operation.
        In doing so, the PowerShell Compact-Archive Tool will perform the uninstall operating within the system.
...
Class Uninstall
{
    ...
    static [Int32] main()
    {
        ...
        if (!$([Uninstall]::FindPowerShellCore()))
        {
        ...
        elseif (!$([Uninstall]::TestFilePath($Global:__PSCAT_COMPLETE_PATH__)))
        {
