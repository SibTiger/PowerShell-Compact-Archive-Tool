...
.DESCRIPTION
    This tool will provide a special instruction to the PowerShell Compact-Archive Tool to perform an uninstall operation.
...
Class Uninstall
{
    ...
    # -------------------------------
    # Documentation:
    #   This function will execute the PowerShell Compact-Archive Tool and set the Program Mode to 'Uninstall'.
    # -------------------------------
    # Output:
    #   [Int] Exit Code
    ...
    hidden static [Int32] LaunchPSCAT()
    {
        ...
        [Uninstall]::DisplayErrorMessage($errorMessage);


        # Allow the user to read the message.
        [Uninstall]::FetchEnterKey();
    ...
    static [Int32] main()
    {
        ...
        if (![Uninstall]::TestFilePath($Global:__PSCAT_COMPLETE_PATH__))
        {
        ...
        else
        {
            ...
            $exitCode = [Uninstall]::LaunchPSCAT();
