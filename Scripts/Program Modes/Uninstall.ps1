...
<#
.SYNOPSIS
    Deletes data that was generated by the PowerShell Compact-Archive Tool, includes user configuration files.

.DESCRIPTION
    This tool will provide a special instruction to the PowerShell Compact-Archive Tool to perform a deep clean-up operation.
        In doing so, the PowerShell Compact-Archive Tool will expunge files that had previously generated as well as remove
        the current user configuration files.
...
function Initialization()
{
    ...
    Set-Variable -Name "__PSCAT_OPERATION_CODE__" -Value 2 `
        -Option ReadOnly -Scope Global -ErrorAction SilentlyContinue `
        -Visibility Public `
        -Description "Signifies the 'Deep Clean' Operation mode in PowerShell Compact-Archive Tool.";
...
Class DeepClean
{
    ...
    # -------------------------------
    # Documentation:
    #   This function will execute the PowerShell Compact-Archive Tool and set the Program Mode to 'Deep Clean'.
    # -------------------------------
    # Output:
    #   [Int] Exit Code
    ...
    hidden static [Int32] LaunchPSCAT()
    {
        ...
        [DeepClean]::DisplayErrorMessage($errorMessage);


        # Allow the user to read the message.
        [DeepClean]::FetchEnterKey();
    ...
    static [Int32] main()
    {
        ...
        if (![DeepClean]::TestFilePath($Global:__PSCAT_COMPLETE_PATH__))
        {
        ...
        else
        {
            ...
            $exitCode = [DeepClean]::LaunchPSCAT();
