...
.DESCRIPTION
    ...
    Tools that this program utilizes are:
        dotNET Framework 5.0 Minimum (Windows Platform)
            The required framework that is needed in order for this program to run successfully on the Windows Platform.
        dotNET Core 2.1.x Minimum (*nix Platform)
            The required framework that is needed in order for this program to run successfully on the *nix Platform.
        7Zip [Optional]
