...
.DESCRIPTION
    This program will set an instruction code to the PowerShell Compact-Archive Tool to perform the Uninstall Operation.
     In doing so, the PowerShell Compact-Archive Tool will execute the payload to perform the Uninstall action.
